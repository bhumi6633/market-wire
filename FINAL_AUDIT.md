...
- End-to-end fault injection: 50,000 binary A/D messages were wrapped in MoldUDP64, shuffled with seed `0xC01716A9`, duplicated periodically, and passed through recovery, generated decoding, and the arena book. The engine released every sequence from 1 through 50,000 in order, and the final hash matched the ordered run.
